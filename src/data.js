...
export const paket = [
  { id: 1, name: 'Basic', unavailable: false },
  { id: 2, name: 'Premium', unavailable: false },
  { id: 3, name: 'Exlusive', unavailable: false },
]
export const desain = [
  { id: 1, name: 'pilih desain', unavailable: true },
  { id: 2, name: 'desain1', unavailable: false },
  { id: 3, name: 'desain2', unavailable: false },
  { id: 4, name: 'desain3', unavailable: false },
  { id: 5, name: 'desain4', unavailable: false },
]
